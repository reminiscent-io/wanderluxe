        ...
        <AuthProvider>
          ...
          <TooltipProvider>
            ...
            <BrowserRouter>
              ...
              <CookieConsentBanner />
              <AppLayout>
                {/* The fallback fills the viewport. A shorter one leaves the
                    footer on screen, and the page that replaces it then pushes
                    the footer off, which counts as layout shift. */}
