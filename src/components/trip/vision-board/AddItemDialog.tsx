        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="title" value={title} onChange={e => setTitle(e.target.value)} placeholder="Enter a title" required />
            </div>

            <div>
              <Label htmlFor="description">Description</Label>
              <Textarea id="description" value={description} onChange={e => setDescription(e.target.value)} placeholder="Add some details..." rows={3} />
            </div>

            <div>
              <Label htmlFor="sourceUrl" className="flex items-center gap-2">
                Source URL
                {isFetchingMetadata && <Loader2 className="h-4 w-4 animate-spin text-gray-500" />}
              </Label>
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button type="submit" disabled={isSubmitting} className="bg-earth-500 hover:bg-earth-400 text-earth-50">
